;;; mock-ecc-term-claude-setup.el --- Mock of term-claude-setup for testing -*- lexical-binding: t -*-
...
;;; Commentary:
;; A mock version of ecc-term-claude-setup.el for testing.
...
(defun ecc-term-claude-check-state ()
  "Mock function to check Claude state."
  (message "Checking Claude state"))
...
(defun ecc-term-claude-follow-bottom-after-output ()
  "Mock function for follow-bottom behavior."
  (message "Following bottom after output"))
...
;; Mock functions for keybinding setup
(defun ecc-term-claude-send-yes ()
  "Mock function to send yes.")

(defun ecc-term-claude-send-no ()
  "Mock function to send no.")

(defun ecc-term-claude-clear ()
  "Mock function to clear buffer.")

(defun ecc-term-claude-toggle-auto-mode ()
  "Mock function to toggle auto mode.")

(defun ecc-term-claude-toggle-follow-bottom ()
  "Mock function to toggle follow bottom.")

(defun ecc-vterm-yank-as-file ()
  "Mock function to yank as file.")

(defun ecc-vterm-yank-buffer-as-file ()
  "Mock function to yank buffer as file.")

(defun ecc-vterm-quick-yank-region ()
  "Mock function to quick yank region.")

(define-derived-mode ecc-term-claude-mode vterm-mode "Claude-Term"
  "Major mode for interacting with Claude in a vterm buffer.")

(provide 'ecc-term-claude-setup)

;;; mock-ecc-term-claude-setup.el ends here