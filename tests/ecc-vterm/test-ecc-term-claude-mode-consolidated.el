...
;;; File: /home/ywatanabe/.dotfiles/.emacs.d/lisp/emacs-claude-code/tests/ecc-vterm/test-ecc-term-claude-mode-consolidated.el

;;; Commentary:
;;; Tests for the consolidated Claude term mode functionality.
...
(ert-deftest test-ecc-term-claude-mode-consolidated-definition ()
  "Test that the consolidated Claude term mode is properly defined."
