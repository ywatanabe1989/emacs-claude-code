...
;;; Author: ywatanabe
;;; Timestamp: <2025-06-04 07:05:00>
;;; File: /home/ywatanabe/.dotfiles/.emacs.d/lisp/emacs-claude-code/src/ecc-host-switch.el
...
(defun ecc-switch-host ()
  ...
  (let* ((hosts (append '("localhost" "local") ecc-ssh-hosts-cache))
         ...
         (selected (completing-read 
                   (format "Switch to host (current: %s): " current-host)
...
(defun ecc-refresh-ssh-hosts ()
  ...
  (interactive)
  (setq ecc-ssh-hosts-cache (--ecc-parse-ssh-config))
  (message "SSH hosts cache refreshed: %d hosts found" 
