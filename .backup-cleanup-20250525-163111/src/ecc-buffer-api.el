...
;;;###autoload
(defalias 'ecc-buffer-auto-response-enable 'ecc-buffer-auto-response-enable
  "Alias for enabling buffer-specific auto-response.")

;;;###autoload
(defalias 'ecc-buffer-auto-response-disable 'ecc-buffer-auto-response-disable
  "Alias for disabling buffer-specific auto-response.")

;;;###autoload
(defalias 'ecc-buffer-auto-response-toggle 'ecc-buffer-auto-response-toggle
