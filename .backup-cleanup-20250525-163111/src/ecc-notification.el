...
(defalias 'ecc-notification-toggle 'ecc-notification-toggle
  "Compatibility alias for toggling notifications.")

(defalias 'ecc-notification-toggle-bell 'ecc-notification-toggle-bell
  "Compatibility alias for toggling bell notifications.")

(defalias 'ecc-notification-check-state 'ecc-notification-check-state
  "Compatibility alias for checking state.")

(defalias 'ecc-notification-dispatch 'ecc-notification-dispatch
  "Compatibility alias for notification dispatch.")

(defalias 'ecc-notification-ring-bell 'ecc-notification-ring-bell
  "Compatibility alias for bell function.")

(defalias 'ecc-notification-flash-mode-line 'ecc-notification-flash-mode-line
  "Compatibility alias for flash function.")

(defalias 'ecc-notification-setup-for-buffer 'ecc-notification-setup-for-buffer
