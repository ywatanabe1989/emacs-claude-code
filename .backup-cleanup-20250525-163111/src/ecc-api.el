...
;;;###autoload
(defalias 'ecc-auto-response-enable 'ecc-auto-response-enable
  "Alias for enabling auto-response.")

;;;###autoload
(defalias 'ecc-auto-response-disable 'ecc-auto-response-disable
  "Alias for disabling auto-response.")

;;;###autoload
(defalias 'ecc-auto-response-toggle 'ecc-auto-response-toggle
  "Alias for toggling auto-response.")

;;;###autoload
(defalias 'ecc-auto-response-yes 'ecc-auto-response-yes
  "Alias for sending yes response.")

;;;###autoload
(defalias 'ecc-auto-response-yes-plus 'ecc-auto-response-yes-plus
  "Alias for sending yes-plus response.")

;;;###autoload
(defalias 'ecc-auto-response-continue 'ecc-auto-response-continue
